        ...
        <tbody>
          {trucks.map(truck => (
            <tr key={truck.vehicle_number}>
              <td className="py-2 px-4 border-b">{truck.vehicle_number}</td>
              <td className="py-2 px-4 border-b">{truck.capacity}</td>
              <td className="py-2 px-4 border-b">{truck.driver_name}</td>
            </tr>
          ))}
        </tbody>
      </table>
